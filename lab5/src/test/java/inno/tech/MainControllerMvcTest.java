...
public class MainControllerMvcTest {
    ...
    public void happyAccountCreateRequest() throws Exception {
        ...
        var responseObj = OBJECT_MAPPER.readValue(responseString, AccountCreateResponseDto.class);
    ...
    public void happyInstanceCreateRequest() throws Exception {
        ...
        String responseString = result.getResponse().getContentAsString();
        assertNotNull(responseString);
        var responseObj = OBJECT_MAPPER.readValue(responseString, InstanceCreateRequestDto.class);
        assertNotNull(responseObj);
    }
